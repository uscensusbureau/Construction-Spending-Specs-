series{title='S052C  Other School'
name='s052c'
file='052c.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal LS2003.Jan LS2016.Jun)}
arima {model=(2 1 0)}
...
seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x5 s3x9	s3x9 s3x9 s3x5 s3x9 s3x9 s3x5)
save=d16
appendfcst=yes
