series{title='S0721UNA Fire station'
    file='s0721una.dat' format='datevalue'
    span=(2002.1,)
    comptype=add
}
spectrum{savelog=all}
transform{function=log print=brief}
regression{variables=(ao2014.oct tc2005.sep)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x5 s3x5 s3x5 s3x5 s3x5 s3x5 s3x9 s3x5 s3x5 s3x9 s3x5 s3x9)
