series{title='N0313UNA Parking garage/lot'
    file='n0313una.dat' format='datevalue'
    span=(2002.1,)
    comptype=add
}
spectrum{savelog=all}
transform{function=log print=brief}
regression{variables=(ls2003.oct tc2010.oct ls2012.nov)}
...
x11{sigmalim=(1.5 3.0)
    seasonalma=(s3x5 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x5 s3x5 s3x9)
