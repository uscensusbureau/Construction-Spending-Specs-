series{title='S0535UNA Dormitory'
    file='s0535una.dat' format='datevalue'
    span=(2002.1,)
    comptype=add
}
spectrum{savelog=all}
transform{function=log print=brief}
regression{variables=(seasonal tc2005.dec)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x5 s3x5 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9)
