series{title='S0539UNA (Power plants, water, sewage, etc.)'
    file='s0539una.dat' format='datevalue'
    span=(2002.1,)
    modelspan=(2004.1,)
    comptype=add
}
...
regression{variables=(seasonal tc2011.jul)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9)
