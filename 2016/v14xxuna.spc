series{title='V14XXUNA WATER SUPPLY SYSTEM'
    file='v14xxuna.dat' format='datevalue'
    span=(2002.1,)
    modelspan=(2008.1,)
    comptype=add
}
...
regression{variables=(tc2015.dec ao2010.mar ao2012.jun)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x9 s3x9 s3x9 s3x5 s3x9 s3x5 s3x9 s3x5 s3x9 s3x5 s3x5 s3x5)
