series{title='V054XUNA Special school'
    file='v054xuna.dat' format='datevalue'
    span=(2002.1,)
    modelspan=(2004.1,)
    comptype=add
}
...
regression{variables=(ls2005.may ao2005.jul seasonal)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x9 s3x5 s3x9 s3x5 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x9)
