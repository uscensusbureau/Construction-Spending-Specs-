series{title='S0523UNA High school'
    file='s0523una.dat' format='datevalue'
    span=(2002.1,)
    comptype=add
}
spectrum{savelog=all}
transform{function=log print=brief}
regression{variables=(tc2012.jun)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x5 s3x9 s3x9 s3x5 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x5)
