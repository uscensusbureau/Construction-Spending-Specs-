series{title='S11XXUNA POWER'
    file='s11xxuna.dat' format='datevalue'
    span=(2002.1,)
    modelspan=(2004.1,)
    comptype=add
}
...
regression{variables=(tc2009.mar)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x9 s3x9 s3x5 s3x5 s3x9 s3x5 s3x9 s3x9 s3x5 s3x5 s3x5 s3x5)
