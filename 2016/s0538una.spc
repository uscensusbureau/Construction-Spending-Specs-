series{title='S0538UNA Sport/Recreational facility'
    file='s0538una.dat' format='datevalue'
    span=(2002.1,)
    modelspan=(2003.1,)
    comptype=add
}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9)
