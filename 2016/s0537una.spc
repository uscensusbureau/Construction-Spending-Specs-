series{title='S0537UNA Student union building/Cafeteria'
    file='s0537una.dat' format='datevalue'
    span=(2002.1,)
    comptype=add
}
spectrum{savelog=all}
transform{function=log print=brief}
regression{variables=(seasonal tc2002.sep)}
...
x11{sigmalim=(1.5 2.5)
    seasonalma=(s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9)
