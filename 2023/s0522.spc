...
series{title='S0522  Junior high                                       '
name='S0522'
file='S0522.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal td1coef TC2015.Jul AO2016.May)}
arima {model=(0 1 0)}
...
seasonalma=(s3x5 s3x5 s3x5 s3x5 s3x9 s3x5 s3x5 s3x5 s3x5 s3x9 s3x5 s3x5)
save=d16
appendfcst=yes
