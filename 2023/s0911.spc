...
series{title='S0911  Passenger terminal-air                            '
name='S0911'
file='S0911.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal AO2011.Nov AO2016.Dec)}
arima {model=(1 1 0)}
...
seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x5 s3x5 s3x9)
save=d16
appendfcst=yes
