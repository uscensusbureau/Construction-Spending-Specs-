...
series{title='N0313  Parking garage/lot                                '
name='N0313'
file='N0313.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal AO2003.Feb LS2003.Oct TC2010.Oct LS2012.Nov)}
arima {model=(0 1 [1,2,4])}
...
seasonalma=(s3x5 s3x9 s3x9 s3x9 s3x5 s3x9 s3x5 s3x9 s3x9 s3x9 s3x5 s3x9)
save=d16
appendfcst=yes
