series{title='N0323UNA  Drive-in restaurant                               '
name='n0323una'
file='n0323una.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal TC2007.Jun)}
arima {model=(0 1 3)}
...
seasonalma=(s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9)
save=d16
appendfcst=yes
