series{title='S1413UNA  Culvert-water supply                              '
name='s1413una'
file='s1413una.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal TC2014.Apr)}
arima {model=(0 1 1)}
...
seasonalma=(s3x5 s3x5 s3x5 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x5)
save=d16
appendfcst=yes
