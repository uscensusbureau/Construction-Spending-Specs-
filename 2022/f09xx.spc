...
series{title='F09XX      TRANSPORTATION                                    '
name='f09xx'
file='f09xx.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal td1coef TC2011.Oct TC2017.Aug)}
...
seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x5 s3x5 s3x9)
save=d16
appendfcst=yes
