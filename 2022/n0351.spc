...
regression {variables=(seasonal td1coef AO2010.Jun AO2018.Feb AO2012.Aug AO2013.Jan)}
arima {model=(2 1 0)}
...
seasonalma=(s3x5 s3x5 s3x5 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9)
save=d16
appendfcst=yes
