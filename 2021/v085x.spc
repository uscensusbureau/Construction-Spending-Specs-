...
series{title='V085X      Social Places                                     '
name='v085x'
file='v085x.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal LS2010.Jun LS2011.May AO2014.Jul LS2013.May)}
arima {model=(0 1 1)}
...
seasonalma=(s3x5 s3x5 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9)
save=d16
appendfcst=yes
