...
series{title='S042X  Medical building                                  '
name='S042X'
file='S042X.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal TC2002.May TC2007.Jan)}
arima {model=(0 1 1)}
...
seasonalma=(s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x5 s3x5)
save=d16
appendfcst=yes
