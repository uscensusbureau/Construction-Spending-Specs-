...
series{title='V10XX  TELECOMMUNICATION                                 '
name='V10XX'
file='V10XX.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(td1coef LS2019.Jan LS2016.Feb LS2015.Apr AO2018.Mar)}
...
seasonalma=(s3x5 s3x5 s3x5 s3x5 s3x9 s3x5 s3x5 s3x5 s3x5 s3x5 s3x9 s3x9)
save=d16
appendfcst=yes
