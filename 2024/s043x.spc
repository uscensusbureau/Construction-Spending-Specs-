...
series{title='S043X  Special care                                      '
name='S043X'
file='S043X.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(td1coef AO2009.Sep)}
arima {model=(0 1 [1,2,4])(0 1 1)}
...
seasonalma=(s3x9 s3x5 s3x9 s3x9 s3x9 s3x5 s3x5 s3x9 s3x5 s3x9 s3x9 s3x5)
save=d16
appendfcst=yes
