...
series{title='S0912  Airport paving, runway                            '
name='S0912'
file='S0912.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal AO2016.Aug)}
arima {model=(0 1 [1,3])}
...
seasonalma=(s3x9 s3x5 s3x5 s3x9 s3x9 s3x9 s3x9 s3x9 s3x5 s3x5 s3x9 s3x9)
save=d16
appendfcst=yes
