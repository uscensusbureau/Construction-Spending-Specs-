series{title='F08XXUNA      AMUSEMENT & RECREATION'
  name='f08xxuna'
  file='f08xxuna.dat'
  format='datevalue'
  span=(1996.1,)
...
regression {variables=(LS2001.Jan AO2006.Sep AO2008.Feb)}
...
x11{sigmalim=(1.8 2.8)
  seasonalma=(s3x5 s3x5 s3x9 s3x5 s3x5 s3x9 s3x9 s3x5 s3x5 s3x5 s3x9 s3x5)
  save=d16
  appendfcst=yes
  savelog=all
