series{title='V20CCUNA      Tobacco/Textile Plant'
  name='v20ccuna'
  file='v20ccuna.dat'
  format='datevalue'
  span=(1997.1,)
...
regression {variables=(LS2004.Oct TC2013.Sep)}
...
x11 {sigmalim=(1.5 2.5)
  seasonalma=(s3x5 s3x5 s3x9 s3x9 s3x5 s3x5 s3x5 s3x5 s3x9 s3x5 s3x9 s3x5)
  save=d16
  appendfcst=yes
  savelog=all
