series{title='F13XX      SEWERAGE & WASTE DISPOSAL                         '
name='f13xx'
file='f13xx.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal LS2017.Jan LS2005.Apr)}
arima {model=(3 1 0)}
...
seasonalma=(s3x9 s3x5 s3x5 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9)
save=d16
appendfcst=yes
