series{title='N0323  Drive-in restaurant                               '
name='n0323'
file='n0323.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(AO2007.Jun seasonal td)}
arima {model=(0 1 [2,3])}
...
seasonalma=(s3x9 s3x9 s3x5 s3x5 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9)
save=d16
appendfcst=yes
