series{title='N0537  Student union building/Cafeteria                  '
name='n0537'
file='n0537.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal TC2007.Jul LS2012.Sep)}
arima {model=(0 1 1)}
...
seasonalma=(s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9)
save=d16
appendfcst=yes
