series{title='S0925  Railroad track, Bridge, etc.                      '
name='s0925'
file='s0925.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal TC2009.Nov AO2010.Feb)}
arima{model=(0 1 3)}
...
seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x5 s3x5 s3x9 s3x5 s3x5 s3x9 s3x5 s3x3)
save=d16
appendfcst=yes
