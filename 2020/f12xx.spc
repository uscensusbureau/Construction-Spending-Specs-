series{title='F12XX      HIGHWAY & STREET                                  '
name='f12xx'
file='f12xx.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal td1coef TC2014.Jan AO2015.Mar)}
arima{model=(0 1 0)}
...
seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x5 s3x9 s3x9 s3x9 s3x5)
save=d16
appendfcst=yes
