series{title='N0341UNA  Electric/computer'
name='n0341una'
file='n0341una.dat'
format='datevalue'
span=(2002.1,)
...
regression {variables=(seasonal AO2013.Feb td)}
arima{model=(0 1 [2])}
...
seasonalma=(s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x9 s3x3 s3x9 s3x9 s3x9)
save=d16
appendfcst=yes
